...
const Response1: React.FC = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Even during moments of high volume, your enterprise’s infrastructure is partitioned from our general API, increasing the reliability of your phone agents.',
      imgSrc: 'Voice.png',
      imgAlt: 'Lightning Bolt',
    },
  ];
